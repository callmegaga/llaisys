...
__C {
    ...
    void llaisysSample(llaisysTensor_t sampled_token, llaisysTensor_t logits, float temperature, int top_k, float top_p) {
        llaisys::ops::sample(sampled_token->tensor, logits->tensor, temperature, top_k, top_p);
    }
